...
public class MaxKColoringTest {
    ...
    public static void main(String[] args) {
        int K = args.length > 0 ? Integer.parseInt(args[0]): 8;
        ...
        if (ef.foundConflict().equals("Failed to find Max-K Color combination !")) {
            optimum = -1;
        } else {
            optimum = ef.value(rhc.getOptimal());
        }

        currTime = System.currentTimeMillis() - starttime;

        System.out.println("RHC," + optimum + "," + currTime);
        ...
        System.out.println("SA," + optimum + "," + currTime);
        ...
        System.out.println("GA," + optimum + "," + currTime);
        ...
        System.out.println("MIMIC," + optimum + "," + currTime);
